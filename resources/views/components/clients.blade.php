...
<section class="px-2 bg-white md:px-0">
    <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
        <div class="flex flex-wrap items-center sm:-mx-3">
            <div class="w-full md:w-2/5 md:px-3">
                <div
                    class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0"
                >
                    <h1
                        class="text-4xl font-extrabold tracking-tight text-black sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl"
                    >
                        <span class="block xl:inline">Clients</span>
                    </h1>
                    <p
                        class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-sm md:max-w-3xl"
                    >
                        May live right quietly his in where plainly seven
                        totally our effort stupid. The a the sentences the let
                        it entered a we check food, asking it try window.
                    </p>
                </div>
            </div>
            <!-- clients logo -->
            <div class="w-full md:w-3/5">
                ...
                >
                    ...
                    >
                        <div
                            class="flex h-[180px] flex-col justify-center rounded-md p-6 items-center"
                        >
                            <svg
                                viewBox="0 0 24 24"
